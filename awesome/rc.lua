...
local editor            = os.getenv("EDITOR") or "mousepad"
...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn NotoMonoRegular:pixelsize=12",
    ...
    awful.key({ modkey }, "F9", function () awful.util.spawn( "rofi -show run" ) end,
        {description = "rofi" , group = "function keys" }),

    -- super + ...
    awful.key({ modkey }, "e", function () awful.util.spawn( filemanager ) end,
        {description = "open file manager", group = "super"}),
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn( editorgui ) end,
        {description = editorgui, group = "super"}),
 ...
 -- Show/Hide Systray
    ...
    -- Brightness
    awful.key({ }, "F12",--"XF86MonBrightnessUp", 
	function () os.execute("xbacklight -inc 10") end,
              {description = "+10%", group = "hotkeys"}),
    awful.key({ }, "F11",--"XF86MonBrightnessDown",
    ...
    awful.key({ }, "F2",--"XF86AudioLowerVolume",
        function ()
            os.execute(string.format("amixer -q set %s 1%%-", beautiful.volume.channel))
            beautiful.volume.update()
        end),
    awful.key({ }, "F1",--"XF86AudioMute",
        function ()
...
awful.rules.rules = {
    ...
    { rule = { class = "Firefox" },
        properties = { screen = 1, tag = awful.util.tagnames[2]--[[, switchtotag = true]], maximized = false } },
...
awful.spawn.with_shell("nitrogen --set-scaled --random ~/Downloads/wallpapers/")
